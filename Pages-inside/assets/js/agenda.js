$(document).ready(function() {
      ...
      while (d.getMonth() == month) {
        table.push('<td><div id="day' + d.getDate() + '" class="dayWrapper">' 
                   ...
                   + '<div class="contentContainer">' 
                      + '<div class="contentItem"><a href="https://www.turgranada.es/agenda" target="_blank">Cultural music and Flamenco</a></div>'
                      + '<div class="contentItem"><a href="https://www.turgranada.es/agenda" target="_blank">Fiesta de las castañas y las calabazas en Padul</a></div>' 
                      + '<div class="contentItem"><a href="https://www.turgranada.es/agenda" target="_blank">Candlelight trae la magia de una experiencia musical en vivo a lugares increíbles en Granada. </a></div>' 
                      + '<div class="contentMore"><a href="https://www.turgranada.es/agenda" target="_blank">More ...</a></div>' 
                   + '</div>' 
                   + '</div></td>');
        if (d.getDay() % 7 == 6) {
          table.push('</tr><tr>');
    ...
    initTemplateCalendar('#calendar',10,2022);
